...
# class Criador(ABC):
#     """
#     A classe Criador declara o método fábrica que deve retornar
#     um objeto da classe Produto. As subclasses de Criador
#     normalmente fornecem a implementação desse método.
#     """
...
#         implementação padrão do método fábrica.
#         """
#         pass

#     def alguma_operacao(self) -> str:
#         """
#         Apesar do nome, a principal responsabilidade do Criador
#         não é criar produtos. Normalmente, ele contém alguma lógica
#         de negócio central que depende dos objetos Produto retornados
#         pelo método fábrica.

#         As subclasses podem alterar indiretamente essa lógica de negócio
#         sobrescrevendo o método fábrica e retornando um tipo diferente
#         de Produto.
#         """
...
# class CriadorConcreto1(Criador):
#     """
#     Observe que a assinatura do método ainda usa o tipo abstrato Produto,
#     mesmo que um produto concreto seja retornado. Dessa forma, o Criador
#     permanece independente das classes concretas de produto.
#     """
...
# """
# Os Produtos Concretos fornecem diferentes implementações
...
#     mas através de sua interface base.

#     Desde que o cliente continue interagindo com o criador pela interface
#     abstrata, é possível passar qualquer subclasse de Criador.
#     """
...
# # Mostre o problema:
# # → Código com if/else para criar produtos diferentes.

# # Apresente a ideia:
# # → Cada subclasse de Criador decide como criar o produto.

# # Explique o benefício:
# # → O código cliente não precisa saber qual classe concreta está sendo usada.
# # → Basta confiar na interface abstrata Produto.

# # Demonstre a execução:
# # → Trocar CriadorConcreto1() por CriadorConcreto2() muda o comportamento sem mudar o cliente.